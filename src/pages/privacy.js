      ...
      <section className="bg-chalk-gray">
        <TermsAndConditionsContainer className="container px-8 py-16 mx-auto font-body">
          ...
          <p>
            ...
            use of Chalk Technologies Ltd.'s Website, located at
            <a
          ...
          <p>
            ...
            conditions. Do not continue to use BETA if you do not agree to take
          ...
          <h2 class="text-2xl font-heading mt-12">Cookies</h2>
          <p>We employ the use of cookies.</p>
          <p>
            By accessing BETA, you agreed to use cookies in agreement with the
            Chalk Technologies Ltd.'s Privacy Policy.
          </p>
          <p>
          ...
          <p>
            You may access this from BETA for your own personal use subjected to
            restrictions set in these terms and conditions.
          </p>
          <p>
            You must not: Republish material from BETA Sell, rent or sub-license
            material from BETA Reproduce, duplicate or copy material from BETA
            Redistribute content from BETA This Agreement shall begin on the
            date hereof.
          </p>
          <p>
          ...
          <p>
            Comments do not reflect the views and opinions of Chalk Technologies
          ...
          <p>
            To the extent permitted by applicable laws, Chalk Technologies Ltd.
          ...
          <p>
            Chalk Technologies Ltd. reserves the right to monitor all Comments
          ...
          <p>
            You hereby grant Chalk Technologies Ltd. a non-exclusive license to
          ...
          <p>
            ...
            Search engines; News organizations; Online directory distributors
          ...
          <p>
            ...
            groups representing charities; online directory distributors;
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Chalk
          ...
          <p>
            ...
            sending an e-mail to Chalk Technologies Ltd. . Please include your
          ...
          <p>Wait 2-3 weeks for a response.</p>
          <p>
          ...
          <p>
            No use of Chalk Technologies Ltd. 's logo or other artwork will be
            allowed for linking absent a trademark license agreement.
          </p>
          <p>
            iFrames Without prior approval and written permission, you may not
            create frames around our Webpages that alter in any way the visual
            presentation or appearance of our Website.
          </p>
          <h2 class="pt-12 text-xl font-heading">Content Liability</h2>
          <p>
          ...
          <p>
            If you are one of the organizations listed in paragraph 2 above and
            are interested in linking to our website, you must inform us by
            sending an e-mail to Chalk Technologies Ltd. .
          </p>
          <p>
          ...
          <p>
            Content Liability We shall not be hold responsible for any content
            that appears on your Website.
          </p>
          <p>
            You agree to protect and defend us against all claims that is rising
            on your Website.
          ...
          <h2 class="pt-12 text-xl font-heading">Your Privacy</h2>
          <p>
          ...
          <p>
            ...
            liability for death or personal injury; limit or exclude our or your
            liability for fraud or fraudulent misrepresentation; limit any of
            our or your liabilities in any way that is not permitted under
            applicable law; or exclude any of our or your liabilities that may
